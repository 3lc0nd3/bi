...
--
-- Host: localhost
-- Generation Time: Sep 29, 2012 at 12:47 PM
...
INSERT INTO `i3` (`id`, `year`, `total_revenue`, `total_expenses`) VALUES
(2, 2008, 480302891, 462300876.26),
(3, 2009, 533244635.31, 480256523.15),
(4, 2010, 613060524.97, 519999437.55),
(5, 2011, 606719057.23, 539369800),
(6, 2012, 605394610.776949, 593673944.407403),
(7, 2013, 639261898.085437, 621811284.27301),
(8, 2014, 679437412.819947, 657548842.831122),
(9, 2015, 700030473.938147, 694536788.793274),
(10, 2016, 725971400.497347, 730668467.36787);

-- --------------------------------------------------------

--
-- Stand-in structure for view `i3_calculado`
--
CREATE TABLE IF NOT EXISTS `i3_calculado` (
`id` int(11)
,`year` int(11)
,`total_revenue` double
,`total_expenses` double
,`net_operating_result` double
);
-- --------------------------------------------------------

--
-- Table structure for table `i6`
--

CREATE TABLE IF NOT EXISTS `i6` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `year` int(11) NOT NULL,
  `institution` varchar(300) NOT NULL,
  `total_revenue` double NOT NULL,
  `total_staff_cost` double NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=23 ;

--
-- Dumping data for table `i6`
--

INSERT INTO `i6` (`id`, `year`, `institution`, `total_revenue`, `total_staff_cost`) VALUES
(2, 2009, 'Charles Darwin University', 207084, 103903),
(3, 2009, 'The University of Newcastle', 497866, 258819),
(4, 2009, 'Griffith University', 675186, 352865),
(5, 2009, 'James Cook University', 306762, 157288),
(6, 2009, 'Murdoch University', 275113, 147424),
(7, 2009, 'The Flinders University of South Australia', 320695, 182902),
(8, 2009, 'La Trobe University', 526646, 295373),
(9, 2010, 'Charles Darwin University', 223577, 117361),
(10, 2010, 'The University of Newcastle', 523171, 289159),
(11, 2010, 'Griffith University', 730560, 384033),
(12, 2010, 'James Cook University', 326593, 174539),
(13, 2010, 'Murdoch University', 304958, 152788),
(14, 2010, 'The Flinders University of South Australia', 374134, 201833),
(15, 2010, 'La Trobe University', 605134, 329212),
(16, 2011, 'Charles Darwin University', 223577, 121488.369148116),
(17, 2011, 'The University of Newcastle', 523171, 284283.229382223),
(18, 2011, 'Griffith University', 730560, 396975.283525801),
(19, 2011, 'James Cook University', 326593, 177465.709555056),
(20, 2011, 'Murdoch University', 304958, 165709.576918338),
(21, 2011, 'The Flinders University of South Australia', 374134, 203298.771800594),
(22, 2011, 'La Trobe University', 619599, 329000);

-- --------------------------------------------------------

--
-- Table structure for table `i7`
--

CREATE TABLE IF NOT EXISTS `i7` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `year` int(11) NOT NULL,
  `institution` varchar(300) NOT NULL,
  `total_revenue` double NOT NULL,
  `total_academic_staff_costs` double NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=23 ;

--
-- Dumping data for table `i7`
--

INSERT INTO `i7` (`id`, `year`, `institution`, `total_revenue`, `total_academic_staff_costs`) VALUES
(2, 2009, 'Charles Darwin University', 207084, 58050),
(3, 2009, 'The University of Newcastle', 497866, 131758),
(4, 2009, 'Griffith University', 675186, 180293),
(5, 2009, 'James Cook University', 306762, 79984),
(6, 2009, 'Murdoch University', 275113, 73861),
(7, 2009, 'The Flinders University of South Australia', 320695, 99060),
(8, 2009, 'La Trobe University', 526646, 145251),
(9, 2010, 'Charles Darwin University', 223577, 64252),
(10, 2010, 'The University of Newcastle', 523171, 148147),
(11, 2010, 'Griffith University', 730560, 196946),
(12, 2010, 'James Cook University', 326593, 89323),
(13, 2010, 'Murdoch University', 304958, 76713),
(14, 2010, 'The Flinders University of South Australia', 374134, 108608),
(15, 2010, 'La Trobe University', 605134, 170177),
(16, 2011, 'Charles Darwin University', 252642.01, 70622.4447295751),
(17, 2011, 'The University of Newcastle', 591183.23, 165256.779684925),
(18, 2011, 'Griffith University', 825532.8, 230765.835580755),
(19, 2011, 'James Cook University', 369050.09, 103162.651308346),
(20, 2011, 'Murdoch University', 344602.54, 96328.6898913652),
(21, 2011, 'The Flinders University of South Australia', 422771.42, 118179.677410712),
(22, 2011, 'La Trobe University', 619599, 173200);

-- --------------------------------------------------------

--
-- Table structure for table `o4`
--
...
CREATE TABLE IF NOT EXISTS `o4` (
  ...
  `institution` varchar(300) NOT NULL,
  `total_revenue` double NOT NULL,
  `net_operating_result` double NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=16 ;

--
-- Dumping data for table `o4`
--

INSERT INTO `o4` (`id`, `year`, `institution`, `total_revenue`, `net_operating_result`) VALUES
(1, 2009, 'Charles Darwin University', 207084, 15691),
(2, 2009, 'The University of Newcastle', 497866, 40966),
(3, 2009, 'Griffith University', 675186, 94395),
(4, 2009, 'James Cook University', 306762, 19994),
(5, 2009, 'Murdoch University', 275113, 11258),
(6, 2009, 'The Flinders University of South Australia', 320695, 29577),
(7, 2009, 'La Trobe University', 526646, 52744),
(8, 2010, 'Charles Darwin University', 223577, 15204),
(9, 2010, 'The University of Newcastle', 523171, 36524),
(10, 2010, 'Griffith University', 730560, 109806),
(11, 2010, 'James Cook University', 326593, 18442),
(12, 2010, 'Murdoch University', 304958, 32401),
(13, 2010, 'The Flinders University of South Australia', 374134, 56398),
(14, 2010, 'La Trobe University', 605134, 99240),
(15, 2011, 'La Trobe University', 619599, 85604);

-- --------------------------------------------------------

--
-- Stand-in structure for view `o4_calculado`
--
CREATE TABLE IF NOT EXISTS `o4_calculado` (
`id` int(11)
,`year` int(11)
,`institution` varchar(300)
,`total_revenue` double
,`net_operating_result` double
,`operating_marging` double
);
-- --------------------------------------------------------
...
--
-- Structure for view `i3_calculado`
--
DROP TABLE IF EXISTS `i3_calculado`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `i3_calculado` AS select `i3`.`id` AS `id`,`i3`.`year` AS `year`,`i3`.`total_revenue` AS `total_revenue`,`i3`.`total_expenses` AS `total_expenses`,(`i3`.`total_revenue` - `i3`.`total_expenses`) AS `net_operating_result` from `i3` where 1;

-- --------------------------------------------------------

--
-- Structure for view `o4_calculado`
--
DROP TABLE IF EXISTS `o4_calculado`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `o4_calculado` AS select `o4`.`id` AS `id`,`o4`.`year` AS `year`,`o4`.`institution` AS `institution`,`o4`.`total_revenue` AS `total_revenue`,`o4`.`net_operating_result` AS `net_operating_result`,(`o4`.`net_operating_result` / `o4`.`total_revenue`) AS `operating_marging` from `o4` where 10;
